...
use DamDan\AppBundle\Entity\Customer;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $customers = $em->getRepository('DamDanAppBundle:Customer')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('DamDan\AppBundle\Form\CustomerType', $customer);
    ...
    {
        $deleteForm = $this->createDeleteForm($customer);
        $editForm = $this->createForm('DamDan\AppBundle\Form\CustomerType', $customer);
