...
class ReservationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reservations = $em->getRepository('DamDanAppBundle:Reservation')->findAll();

        return $this->render('DamDanAppBundle:reservation:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $reservation->setAcceptedPending();
            $em = $this->getDoctrine()->getManager();
    ...
    public function showAction(Reservation $reservation)
    {
        ...
        return $this->render('DamDanAppBundle:reservation:show.html.twig', array(
            'reservation' => $reservation,
    ...
    public function editAction(Request $request, Reservation $reservation)
    {
        ...
        return $this->render('DamDanAppBundle:reservation:edit.html.twig', array(
            'reservation' => $reservation,
